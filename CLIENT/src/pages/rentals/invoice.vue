...
const totalPriceAfterDiscount = computed(() => {
  ...
  return totalPrice.value * (1 - discount / 100)
})
      ...
      <div v-else>
        <VRow>
          ...
          >
            ...
            <p>
              <strong>{{ $t('Status') }}:</strong> <span class="text-success">ជួល</span>
            </p>
          </VCol>
        </VRow>
        ...
        <div class="text-right mt-6">
          <p>
            <strong>{{ $t('Sub_Total') }}:</strong> ${{ formatNumber(totalPriceAfterDiscount) }}
          </p>
          <p>
