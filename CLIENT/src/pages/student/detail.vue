  ...
  <div>
    ...
    <v-card class="mt-7">
      ...
      <v-row>
        ...
        <v-col>
          <v-row class="align-center mx-4">
            <v-card-title class="text-center  bg-success rounded-pill w-25 " style="padding: 2px;"> {{ $t('profile') }} </v-card-title>
            <v-card-title class="bg-success rounded-pill w-75" style="margin-left: -3px; padding: 3px;"> </v-card-title>
          </v-row> 
          <v-row>
            <v-col>
      ...
      <v-row class="mx-2">
        <v-col>
          <v-row class="align-center mx-1">
                <v-card-title class="bg-primary rounded-pill w-25 text-center" style="padding: 2px;">{{ $t('pob') }}</v-card-title>
                <v-card-title class="bg-primary rounded-pill w-75 " style="margin-left: -3px; font-size: 12px; padding: 3px;"> </v-card-title>
          </v-row>
          <v-row>
            <v-col>
        ...
        <v-col>
          <v-row class="align-center mx-1">
              <v-card-title class="bg-primary rounded-pill w-25 text-center" style="padding: 2px">{{ $t('add') }}</v-card-title>
              <v-card-title class="bg-primary rounded-pill w-75 " style="margin-left: -3px; font-size: 12px; padding: 3px;"> </v-card-title>
          </v-row>
          <v-row>
            <v-col>
      ...
      <v-row class="mx-2">
        <v-col col="12">
          <v-row class="align-center mx-1">
              <v-card-title class="bg-primary rounded-pill w-25 text-center " style="padding: 2px;">{{ $t('father_infor') }}</v-card-title>
              <v-card-title class="bg-primary rounded-pill w-75 " style="margin-left: -3px; font-size: 12px; padding: 3px;"> </v-card-title>
          </v-row>
          <v-row>
            <v-col>
        ...
        <v-col>
          <v-row class="align-center mx-1">
              <v-card-title class="bg-primary rounded-pill w-25 text-center" style="padding: 2px;">{{ $t('mother_infor') }}</v-card-title>
              <v-card-title class="bg-primary rounded-pill w-75 " style="margin-left: -3px; font-size: 12px; padding: 3px;"> </v-card-title>
          </v-row>
          <v-row>
            <v-col>
              <v-card-text>{{ $t('headers.name') }} : {{ student.m_last_name + ' ' + student.m_first_name }}</v-card-text>
      ...
      <v-row class="mx-2">
        <v-col cols="12">
          <v-row class="align-center mx-1">
                <v-card-title class="bg-primary rounded-pill w-25  text-center" style="padding: 3px;">{{ $t('guardian') }}</v-card-title>
                <v-card-title class="bg-primary rounded-pill w-75" style="margin-left: -3px; padding: 3px;"> </v-card-title>
          </v-row>
          <v-row>
            <v-col cols="12" md="4">
                <v-card-text>{{ $t('headers.name') }} : {{ student.g_last_name + ' ' + student.g_first_name }}</v-card-text>
