...
-- Teachers Data
-- ---------------------
INSERT INTO `teachers` (`id`, `code`, `name`, `name_latin`, `sex`, `dob`, `photo_path`, `pob`, `address`, `position`, `phone`, `created_by`, `updated_by`, `deleted_at`, `created_at`, `updated_at`) VALUES ('87bdecf3-1b6a-11ef-a21e-047c163993b6', '0222', 'ដួង ដាលីន', 'Doung Dalin', 2, '1998-05-15', NULL, 'បាត់ដំបង', 'បាត់ដំបង', 3, '098 78 66 34', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `teachers` (`id`, `code`, `name`, `name_latin`, `sex`, `dob`, `photo_path`, `pob`, `address`, `position`, `phone`, `created_by`, `updated_by`, `deleted_at`, `created_at`, `updated_at`) VALUES ('8aa5780f-29e2-414b-8a9a-3963fbe55cec', 'aass', 'រ៉ាហ្វាត់', 'RAFATZ', 1, NULL, NULL, NULL, NULL, 1, '0', '6a0652a1-c83f-4233-9bdb-85ce5851dca7', '6a0652a1-c83f-4233-9bdb-85ce5851dca7', NULL, '2024-05-26 14:16:38', '2024-05-28 15:04:32');
-- ---------------------
-- Room Data
-- ---------------------
...
-- Level Data
-- ---------------------
INSERT INTO `levels` (`id`, `level`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES (1, 'Level 1', '6a0652a1-c83f-4233-9bdb-85ce5851dca7', NULL, '2024-05-29 10:09:02', '2024-05-31 03:08:11');
