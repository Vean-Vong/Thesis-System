...
<template>
  <div style="width: 100%">
      ...
      <table width="100%" style="border: none; margin: 10px 90px">
        <tr>
          <td style="border: none">
            ...
            <h3 class="my-4">
              ក្រុង ស្រុក ខណ្ឌ <span class="pl-2">{{ address?.district?.namekh }}</span>
            </h3>
            <h3>
              ឃុំ សង្កាត់
              <span class="pl-2">
    ...
    <div class="text-center my-4">
      <h1 v-if="data?.type == 1">សេចក្តីចម្លងសំបុត្រមរណភាព</h1>
      <h1 v-if="data?.type == 2">សេចក្តីចម្លងសំបុត្របញ្ជាក់មរណភាព</h1>
    </div>
    <br />
    <!-- death table -->
    <div class="mx-auto dark:border" style="border: 2px solid grey; width: 90%">
      <table width="100%" border="1 | 0">
        ...
        <tr>
          <td class="text-center" colspan="6">ចម្លងសំបុត្រមរណភាពចេញពី</td>
          <td colspan="5">
            <p class="text-center">សៀវភៅមរណភាព</p>
            <p class="mx-2">លេខ {{ data.book }}</p>
          </td>
          <td colspan="9">
            <p class="text-center">សំបុត្រមរណភាព</p>
            <p class="mx-2">
        ...
        <tr>
          <td colspan="6">
            <p class="text-center mt-2 mx-2">ស្ថានភាពសព</p>
            <p class="text-left mx-2">នៅលីវ មានប្តី មានប្រពន្ធ ពោះម៉ាយ មេម៉ាយ</p>
          </td>
          <td colspan="15">
            <p class="mt-3 text-center">{{ data?.status }}</p>
          </td>
        </tr>

        <tr>
          <td colspan="6">
            <p class="mt-2 mx-2">ថ្ងៃ ខែ ឆ្នាំស្លាប់</p>
          </td>
          <td colspan="15">
            <p class="mt-3 text-center">{{ data?.date_of_death }}</p>
          </td>
        </tr>

        <tr>
          <td colspan="6" style="border-top: 3px solid gray">
            <p class="ml-2 mt-2">នាមត្រកូល និងនាមខ្លួនឳពុកសព</p>
            <hr
              style="
                height: 2px;
                border-width: 0;
          ...
          <td class="text-center" colspan="12" style="border-top: 3px solid gray">
            <p>{{ data?.dad }}</p>
            ...
            <p style="position: relative; top: 10px">{{ data?.dad_latin }}</p>
          </td>
          <td class="text-center" colspan="3" style="border-top: 3px solid gray">
            <p>សញ្ជាតិ</p>
            <p>ខ្មែរ</p>
          </td>
        </tr>
        ...
        <tr>
          <td colspan="6">
            <p class="ml-2 mt-2">នាមត្រកូល និងនាមខ្លួនម្តាយសព</p>
            <hr
              style="
                height: 2px;
                border-width: 0;
          ...
          <td class="text-center" colspan="12">
            ...
            <p style="position: relative; top: 10px">{{ data?.mum_latin }}</p>
          </td>
          <td class="text-center" colspan="3">
            <p>សញ្ជាតិ</p>
            <p>ខ្មែរ</p>
