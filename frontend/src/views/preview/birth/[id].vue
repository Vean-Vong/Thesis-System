  ...
  <div style="width: 100%">
    ...
    <div>
      ...
      <div class="text-center my-4">
        <h1>សេចក្តីចម្លងសំបុត្រកំណើត</h1>
      </div>
      ...
      <div class="mx-auto dark:border" style="border: 2px solid grey; width: 90%">
        <table width="100%" border="1 | 0">
          ...
          <tr>
            ...
            <td colspan="5">
              <p class="text-center pa-2">សៀវភៅកំណើត</p>
              <p class="mx-2">
          ...
          <tr>
            <td colspan="6">
              <p class="mx-2 mt-2">ទីលំនៅពេលទារកកើត</p>
            </td>
            <td colspan="15">
              <p class="text-center mt-3">{{ data?.pob }}</p>
            </td>
          </tr>
        </table>
      </div>
