...
<template>
  <div>
    <VCard title="តារាងសិស្ស" class="mb-5">
      <VDivider />
      <VCard-text>
        <VRow justify="start">
          <VCol cols="12" md="4">
        ...
        >
          ...
          <tbody>
            ...
            <tr v-for="row in data" :key="row.id">
              ...
              <td v-text="row.dad_name" />
              <td v-text="row.dad_phone" />
              <td v-text="row.mom_name" />
              <td v-text="row.mom_phone" />
              <td>
    ...
    <v-dialog v-model="confirmDialog" style="max-width: 500px" persistent>
      <v-card>
        <v-card-text> តើអ្នកប្រាកដក្នុងការលុបសិស្សនេះទេ </v-card-text>
