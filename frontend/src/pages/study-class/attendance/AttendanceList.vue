          ...
          <q-markup-table>
            ...
            <tbody>
              <tr
                ...
                v-for="(ret, index) in form.details"
                :key="index"
              >
                ...
                <td class="text-center">
                  {{ ret.absent == 1 ? "No Permission" : "Permission" }}
                </td>
                <td class="text-center">
                  {{ ret.reason }}
                </td>
              ...
              <tr v-else>
                <td colspan="5" class="text-center">No Absent</td>
              </tr>
            </tbody>
          </q-markup-table>
        </q-card>
  ...
  methods: {
    ...
    async onSearch() {
      ...
      if (valid) {
        ...
        axiosApiInstance
          .post(
            `study-classes/${this.$route.params.studyclass}/attendances/list`,
            this.form
          )
          .then((res) => {
